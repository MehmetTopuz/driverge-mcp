...
//
// I2C/SPI/UART only: the I2C seam references `${PREFIX}_I2C_ADDR`, a macro the
// portable core only defines for I2C parts; the SPI seam needs the portable
// core's hal_spi_transfer declaration; the UART seam (Session B) wraps ESP-IDF's
// uart driver around hal_uart_write/hal_uart_read — any other bus (unknown) has
// no ESP-IDF seam here, so this target refuses (UnsupportedBusError) rather than
